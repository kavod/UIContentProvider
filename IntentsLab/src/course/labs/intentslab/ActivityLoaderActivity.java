...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		Intent helloAndroidIntent = new Intent(ActivityLoaderActivity.this,
				ExplicitlyLoadedActivity.class);
		// TODO - Start an Activity using that intent and the request code defined above
		startActivityForResult(helloAndroidIntent,GET_TEXT_REQUEST_CODE);
	...
	private void startImplicitActivation() {
		...
		chooserIntent = Intent.createChooser(webIntent, CHOOSER_TEXT);
